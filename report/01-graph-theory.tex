...
In the graph below, we partition the edges into two disjoint classes: red lines and blue 
...
\begin{center}
    \begin{tikzpicture}
        ...
        \draw [red] (-0.55,1) -- (0,0);
        \draw [red] (0,0) -- (1,2);
        \draw [red] (1.55,1) -- (-0.55,1);
        \draw [red] (1,0) -- (0,2);
        \draw [blue] (0,0) -- (0,2);
        \draw [blue] (1,0) -- (1,2);
        \draw [blue] (1,0) -- (-0.55,1);
        \draw [blue] (1.55,1) -- (0,2);
        \draw [blue] (1,2) -- (-0.55,1);
        \draw [blue] (0,0) -- (1.55,1);
...
\begin{proof}
    ...
    \begin{figure}[h]
        \begin{center}
            \begin{tikzpicture}
                \draw [red] (0,-0.1) -- (1.2,-0.1);
                \draw [red] (1.2,-0.1) -- (1.65,1.2);
                \draw [red] (1.65,1.2) -- (0.6,2);
                \draw [red] (0.6,2) -- (-0.55,1.2);
                \draw [red] (-0.55,1.2) -- (0,-0.1);
                \draw [blue] (0,-0.1) -- (1.65,1.2);
                \draw [blue] (0,-0.1) -- (0.6,2);
                \draw [blue] (1.2,-0.1) -- (0.6,2);
                \draw [blue] (1.2,-0.1) -- (-0.55,1.2);
                \draw [blue] (1.65,1.2) -- (-0.55,1.2);
        
                \filldraw (0,-0.1) circle (2pt);
                \filldraw (1.2,-0.1) circle (2pt);
                \filldraw (1.65,1.2) circle (2pt);
                \filldraw (0.6,2) circle (2pt);
                \filldraw (-0.55,1.2) circle (2pt);
            \end{tikzpicture}
    ...
    \end{figure}
    Hence we see that there is no triangle with edges of the same colour, so no 
