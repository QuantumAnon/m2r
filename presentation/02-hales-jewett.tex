...
\item<2-> Implies the Van der Waerden theorem: given any k and number of colours
  ...
  (k-1)d\}$ of length k.
\item<3-> $f: (a_1, a_2, \dots, a_N) \mapsto a_1 + a_2 + \dots + a_N$,\\
  $(a_1, a_2, \dots x, \dots, x, \dots, a_N) \mapsto a_1 + a_2 + \dots + a_N + 2x$
\end{itemize}
\end{frame}
...
\begin{theorem} Given any size n of an alphabet $A = \{1, 2, ..., n\}$ and real
  number $\delta$, there exists an $N$ such that for any subset $B \subset
